...
- **1. create_idea** — `hypo_loop`
  - round_1
    ...
    - `chat/prompts/1_create_idea/round_1/2_review_hypo.md` — 4 prompts
- **2. test_idea** — `invention_loop`
  - round_1
    - `chat/prompts/2_test_idea/round_1/1_gen_strat.md` — 5 prompts
    - `2_gen_plan/` — 3 task(s)
      - `chat/prompts/2_test_idea/round_1/2_gen_plan/gen_plan_dataset_1.md` — 58 prompts
      - `chat/prompts/2_test_idea/round_1/2_gen_plan/gen_plan_experiment_1.md` — 28 prompts
    ...
    - `chat/prompts/2_test_idea/round_1/4_gen_paper_text.md` — 44 prompts
  ...
  - round_2
    ...
    - `2_gen_plan/` — 3 task(s)
      - `chat/prompts/2_test_idea/round_2/2_gen_plan/gen_plan_dataset_1.md` — 36 prompts
      - `chat/prompts/2_test_idea/round_2/2_gen_plan/gen_plan_evaluation_1.md` — 8 prompts
      - `chat/prompts/2_test_idea/round_2/2_gen_plan/gen_plan_experiment_1.md` — 36 prompts
    - `3_gen_art/` — 3 task(s)
      - `chat/prompts/2_test_idea/round_2/3_gen_art/gen_art_dataset_1.md` — 13 prompts
      - `chat/prompts/2_test_idea/round_2/3_gen_art/gen_art_evaluation_1.md` — 11 prompts
      - `chat/prompts/2_test_idea/round_2/3_gen_art/gen_art_experiment_1.md` — 13 prompts
    - `chat/prompts/2_test_idea/round_2/4_gen_paper_text.md` — 10 prompts
...
- **3. report_results** — `gen_paper_repo`
  - `1_gen_viz/` — 7 task(s)
    - `chat/prompts/3_report_results/1_gen_viz/gen_viz_1.md` — 12 prompts
    ...
    - `chat/prompts/3_report_results/1_gen_viz/gen_viz_6.md` — 4 prompts
    - `chat/prompts/3_report_results/1_gen_viz/gen_viz_7.md` — 5 prompts
  - `2_gen_demo_art/` — 3 task(s)
    ...
    - `chat/prompts/3_report_results/2_gen_demo_art/gen_demo_art_experiment_1.md` — 12 prompts
  - `3_gen_full_paper/` — 2 task(s)
    - `chat/prompts/3_report_results/3_gen_full_paper/gen_full_paper.md` — 5 prompts
